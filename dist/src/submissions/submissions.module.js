...
exports.SubmissionsModule = SubmissionsModule = __decorate([
    (0, common_1.Module)({
        imports: [submission_templates_module_1.SubmissionTemplatesModule, enrollments_module_1.EnrollmentsModule],
        controllers: [submissions_controller_1.SubmissionsController],
        providers: [submissions_service_1.SubmissionsService, submissions_repository_1.SubmissionsRepository],
        exports: [submissions_service_1.SubmissionsService, submissions_repository_1.SubmissionsRepository],
    })
], SubmissionsModule);
