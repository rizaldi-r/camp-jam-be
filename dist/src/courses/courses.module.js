...
exports.CoursesModule = CoursesModule = __decorate([
    (0, common_1.Module)({
        imports: [instructors_module_1.InstructorsModule, categories_module_1.CategoriesModule],
        controllers: [courses_controller_1.CoursesController],
        providers: [courses_service_1.CoursesService, courses_repository_1.CoursesRepository],
        exports: [courses_service_1.CoursesService, courses_repository_1.CoursesRepository],
    })
], CoursesModule);
